...
1. Synthetic haze generation
2. Classical DCP restoration
3. Residual CNN refinement
4. Radiance reconstruction
...
Implements spatially varying atmospheric scattering using:
